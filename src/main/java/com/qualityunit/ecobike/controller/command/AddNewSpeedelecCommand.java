...
public class AddNewSpeedelecCommand implements Command {
    ...
    public void execute() {
        ...
        brand = ConsoleView.readString("Enter the brand name of a new speedelec, please.");
    ...
    private void correctOneField() {
        ...
        switch (fieldNumber) {
            case 1:
                ...
                break;
            case 2:
                maxSpeed = ConsoleView.readNumberBetween("Enter max speed of a new speedelec in km/h.", 1, 500);
                break;
            case 3:
                weight = ConsoleView.readNumberBetween("Enter the weight of a new bike in grams.", 1, 1_000_000);
                break;
