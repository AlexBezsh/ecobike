...
public class AddNewElectricBikeTest {

    @Test
    public void addNewElectricBike() {
    ...
    @Test
    public void addNewElectricBikeWithChanges() {
        String s ="Brand" +     //brand name
                "\n44" +        //max speed
                "\n12000" +     //weight
                "\n2" +         //no lights
    ...
    @Test
    public void addNewElectricBikeWithValidationCheck() {
